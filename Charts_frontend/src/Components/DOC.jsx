...
function DOC() {
  ...
  //     item['VirtualDistance (m)'] !== undefined && item['DepthOfCover (m)'] !== undefined &&
  //     !isNaN(Number(item['VirtualDistance (m)'])) && !isNaN(Number(item['DepthOfCover (m)']))
  //   );
