...
const FileUploader = ({ setMarkers }) => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div>
        <label><strong>Upload XLI File:</strong> </label><br/>
        <input
          type="file"
          accept=".csv,.xls,.xlsx"
          onChange={onFileChangeXLI}
        />
        {fileNameXLI && <p><strong>Uploaded XLI File:</strong> {fileNameXLI}</p>}
      </div>

      <div>
        <label><strong>Upload ICE File:</strong></label><br/>
        ...
        />
        {fileNameICE && <p><strong>Uploaded ICE File:</strong> {fileNameICE}</p>}
      </div>
